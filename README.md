...
This is the final project for Software I at WGU Online's B.S. CompSci program. This will be a project of many firsts for me as follows.

 - Working with Java
 - Working in IntelliJ IDEA
 - Building a program with a GUI
 - Implementing MVC
 - Implementing UML diagram
 
I plan on using the rubric as a MVP and expanding upon the project afterwards as a teaching tool for myself. I also plan to learn Git by using branches when I need to work on a new requirement for the rubric. 
